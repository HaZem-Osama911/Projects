...
using MyEmailSender = Microsoft.AspNetCore.Identity.UI.Services.IEmailSender;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, "User"); // Assign "User" role to the newly registered user
